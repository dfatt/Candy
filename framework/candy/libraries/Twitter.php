...
class Twitter {
	...
	/**
	 * Will send a tweet with the Text specified in the first parameter
	 $this->tmhOAuth->url('1/statuses/update_with_media')
	 *
	 * @param string $text = the tweet, max 140 chars
	 * @return void
	 * @author demogar
	 */
	public function sendMediaTweet($text, $media)
	{
		$code = $this->tmhOAuth->request('POST', 'https://upload.twitter.com/1/statuses/update_with_media.json',
		  array(
		    'media[]'  => "@{$media}",
		    'status'   => "$text"
		  ),
